...
void Mouse::StartTracking( Vector2Int position) {
	trackingStartPos = position;
	trackingEngaged = true;
}

void Mouse::StopTracking() {
	trackingEngaged = false;
}

Vector2Int Mouse::MoveTracking(Vector2Int position) {
	Vector2Int delta = position - trackingStartPos;
	trackingStartPos = position;
	return delta;
}