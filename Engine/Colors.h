...
public:
	...
	static constexpr int ChannelMaxInt = 255;
	static constexpr float ChannelFloatMax = 1.0;

	//void TextureFromColor
	...
	constexpr Color( unsigned char r,unsigned char g,unsigned char b )
		:
		dword( (1 << 24) | (r << 16u) | (g << 8u) | b )
	{}
	constexpr Color( Color col,unsigned char x )
		:
		Color( (x << 24u) | col.dword )
	{}
	Color(Vector3& rgb) : Color(unsigned char(rgb.x), unsigned char(rgb.y), unsigned char(rgb.z)) {}
